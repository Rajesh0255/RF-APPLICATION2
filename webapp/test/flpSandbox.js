		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comapprfapplication2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapprfapplication2-display": {
								"semanticObject": "comapprfapplication2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.rfapplication2",
									"url": sap.ui.require.toUrl("com/app/rfapplication2")
								}
							}
						}
					}
